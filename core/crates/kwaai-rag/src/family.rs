...
pub async fn seed_family_tree(
    ...
    for person in &tree.persons {
        ...
        // Use YAML description if present; otherwise fall back to any description already in
        // the graph (e.g. auto-generated by enrich-entities on a previous run). This prevents
        // re-seeding from overwriting a rich enriched embedding with a name-only one.
